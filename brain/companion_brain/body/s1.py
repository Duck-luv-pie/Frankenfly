...
DEFAULTS = {
    ...
    "scale": 0.015,          # forward / strafe speed: sticks x this (1 = the fly's full pace, 0.015 = a very slow crawl)
...
def motor_to_sticks(motor: dict, cfg: dict) -> dict:
    ...
    ky = float(cfg.get("scale_yaw", DEFAULTS["scale_yaw"]))
    fwd, strafe, yaw = k * fwd, k * strafe, ky * yaw
    return {
